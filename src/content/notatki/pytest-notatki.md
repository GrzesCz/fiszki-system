...
**Dodatkowe materiały:**
- 📘 [Studium przypadku: projekt `imprv-masterclass-testing`](szczegoly/studium_przypadku_imprv.md) (szczegółowe przykłady kodu, struktura)
- 📙 [Kompendium: Techniki Pytest](szczegoly/kompendium_technik_pytest.md) (słownik markerów, parametryzacji, monkeypatch, xfail itp. w stylu "Zelenta")
- 📗 [ABC + Mock + Fixture – jak to się łączy](szczegoly/abc-mock-fixture-polaczenie.md) (krok po kroku: kontrakt, atrapa, dostawca)
...
**👉 [Zobacz studium przypadku: studium_przypadku_imprv.md](szczegoly/studium_przypadku_imprv.md)**
...
Pełne przykłady (test jednostkowy i integracyjny) są w [studium_przypadku_imprv.md](szczegoly/studium_przypadku_imprv.md). Tu zasada: zawsze starajcie się w testach wyraźnie oddzielić te trzy fazy – wtedy test jest czytelny i łatwy do naprawy.

### Odniesienia
— [studium_przypadku_imprv.md](szczegoly/studium_przypadku_imprv.md) (pełne przykłady GIVEN/WHEN/THEN)
