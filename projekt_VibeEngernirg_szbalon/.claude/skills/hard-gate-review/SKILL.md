...
| 7 | **What can I DELETE without losing a requirement?** Which abstraction has <2 real call sites? Which try/except guards an impossible path? | [Your analysis] |
...
| ✂️ Simplicity | ✅ OK / ❌ FAIL | [speculative abstractions / unreachable guards / what-comments — none or list] |
...
- [ ] All 7 adversarial questions have explicit answers (none skipped).
...
- [ ] Agent explicitly stated: "2x Check complete. Passed X/7 questions without issues, found Y problems, verdict: PASS/FAIL."
...
| "I answered 5 out of 7 questions, the rest are obvious." | **DENIED.** All 7 questions are mandatory. Skipping = procedural violation. |
